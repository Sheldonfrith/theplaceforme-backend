                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('data-input')" :active="$page.currentRouteName == 'data-input'">
                                Data Input
                            </jet-nav-link>
                            <jet-nav-link :href="route('questionaire')" :active="$page.currentRouteName == 'questionaire'">
                                Questionaire
                            </jet-nav-link>
                        </div>
                    </div>
                            ...
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    ...
                                    <button  class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                        <div>{{ $page.user? $page.user.name: 'no user' }}</div>
                                ...
                                <template #content>
                                    ...
                                    <!-- <jet-dropdown-link :href="route('data-input.index')">
                                        Data Input
                                    </jet-dropdown-link> -->
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div class="ml-3">
                            <div class="font-medium text-base text-gray-800">{{ $page.user ? $page.user.name: 'no user' }}</div>
                            <div class="font-medium text-sm text-gray-500">{{ $page.user ? $page.user.email: 'no user' }}</div>
                        </div>
                    </div>
